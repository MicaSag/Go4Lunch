...
public class GooglePlaceStreams {
    ...
    public static Observable<PlaceNearBySearch> streamFetchPlaceNearBySearch(Map<String,String> query){
    ...
    public static Observable<PlaceDetails> streamFetchPlaceDetails(String key, Map<String,String> filters){
        GooglePlaceService googlePlaceService = GooglePlaceService.retrofit.create(GooglePlaceService.class);
        return googlePlaceService.getPlaceDetails(key,filters)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .timeout(10, TimeUnit.SECONDS);
    }
